...
APP_INFO = """Minipad - simple text editor and a basic text-editing program. \
...
Minipad also supports multi-font text."""


# Класс "Minipad"
class Minipad(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        # Инструмент "О программе (About Minipad)"
        self.action_about_box = QAction(QIcon('icons/question_icon.png'), 'About Minipad', self)
    ...
    def show_info_close(self):
        ...
        info_box.setText("Stops Minipad's work and closes it")
        info_box.show()
    ...
    def show_info_about_app(self):
        info_box = QMessageBox(self)
        info_box.setIcon(QMessageBox.Question)
        info_box.setWindowTitle('About Minipad')
    ...
    def closeEvent(self, event):
        ...
        want_to_close = QMessageBox.question(self,
                                             APP_NAME,
                                             'Are you sure want to close Minipad?',
...
if __name__ == '__main__':
    ...
    # Создание и показ пользователю экземпляра MainWindow класса Minipad
    ex = Minipad()
    ex.show()
